...
## REFERENCE: Javascript / Typescript Comment Types
...
## The problem with native nested comments
...
## The benefits of enabling Universal Comment option
...
- The `§` character is used internally as an augmentation marker for block comments (i.e. preventing early termination of nested comments). It was chosen for its rarity across all language comment syntaxes and is not configurable.
- Broadly tested
